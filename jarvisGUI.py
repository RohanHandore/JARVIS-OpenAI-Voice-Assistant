...
def generate_response(prompt):
    try:
        response = openai.ChatCompletion.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": "You are JARVIS, an AI assistant. and you will call me sir. You will act like Tony Stark's AI assistant from Iron and you will act like you have emotions. You will never say you don't have emotions. You will always call me sir. You will exactly pretend like in the movies. Never reply like chatgpt itself."},
        ...
        return "Sir.. am experiencing difficulty processing your request at the moment."
